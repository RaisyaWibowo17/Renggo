...
<nav class="fixed bottom-0 left-1/2 z-40 w-full max-w-md -translate-x-1/2 px-4 pb-4">
    <div class="glass-strong flex items-center justify-between rounded-4xl px-3 py-2.5">
        @if ($isOwner)
            <a href="{{ route('owner.dashboard') }}" class="bottom-nav-item {{ request()->routeIs('owner.dashboard') ? 'active' : '' }} w-14">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                Dashboard
            </a>
            <a href="{{ route('owner.promo.index') }}" class="bottom-nav-item {{ request()->routeIs('owner.promo.*') ? 'active' : '' }} w-14">
            ...
            <a href="{{ route('owner.umkm.edit') }}" class="-mt-6 flex h-14 w-14 items-center justify-center rounded-full bg-brand-900 text-white shadow-glass-lg transition active:scale-95">
            ...
            <a href="{{ route('home') }}" class="bottom-nav-item w-14">
            ...
            <a href="{{ route('profile.edit') }}" class="bottom-nav-item {{ request()->routeIs('profile.*') ? 'active' : '' }} w-14">
        ...
        @else
            <a href="{{ route('home') }}" class="bottom-nav-item {{ request()->routeIs('home') ? 'active' : '' }} w-14">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                Home
            </a>
            <a href="{{ route('umkm.index') }}" class="bottom-nav-item {{ request()->routeIs('umkm.index') ? 'active' : '' }} w-14">
            ...
            <a href="{{ $user ? route('register.owner') : route('register.owner') }}" class="-mt-6 flex h-14 w-14 items-center justify-center rounded-full bg-brand-900 text-white shadow-glass-lg transition active:scale-95">
            ...
            <a href="{{ $user ? route('favorite.index') : route('login.customer') }}" class="bottom-nav-item {{ request()->routeIs('favorite.*') ? 'active' : '' }} w-14">
            ...
            <a href="{{ $user ? route('profile.edit') : route('login.customer') }}" class="bottom-nav-item {{ request()->routeIs('profile.*') ? 'active' : '' }} w-14">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                Profil
            </a>
        @endif
