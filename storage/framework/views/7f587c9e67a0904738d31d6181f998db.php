...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.guest','data' => ['title' => 'Daftar Pelanggan']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes(['title' => 'Daftar Pelanggan']); ?>
    ...
    <form action="<?php echo e(route('register.customer')); ?>" method="POST" enctype="multipart/form-data" class="space-y-4">
        <?php echo csrf_field(); ?>
        <div>
        ...
        <div>
            ...
            <input type="email" name="email" value="<?php echo e(old('email')); ?>" class="input-field" placeholder="nama@email.com" required>
        </div>
        <div>
    ...
    <p class="mt-6 text-center text-sm text-brand-500">
        Sudah punya akun? <a href="<?php echo e(route('login.customer')); ?>" class="font-semibold text-brand-900">Masuk</a>
    </p>
    <p class="mt-2 text-center text-xs text-brand-400">
        Punya UMKM? <a href="<?php echo e(route('register.owner')); ?>" class="font-semibold text-brand-700">Daftar sebagai Pemilik UMKM</a>
    </p>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\renggo\resources\views/auth/register-customer.blade.php ENDPATH**/ ?>