...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.guest','data' => ['title' => 'Masuk Pelanggan']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Masuk Pelanggan']); ?>
    ...
    <form action="<?php echo e(route('login.customer')); ?>" method="POST" class="space-y-4">
        <?php echo csrf_field(); ?>
        <div>
            <label class="field-label">Email</label>
            <input type="text" name="identifier" value="<?php echo e(old('identifier')); ?>" class="input-field" placeholder="nama@email.com" required autofocus>
        </div>
        <div>
    ...
    <p class="mt-6 text-center text-sm text-brand-500">
        Belum punya akun? <a href="<?php echo e(route('register.customer')); ?>" class="font-semibold text-brand-900">Daftar</a>
    </p>
    <p class="mt-2 text-center text-xs text-brand-400">
        Anda Pemilik UMKM? <a href="<?php echo e(route('login.owner')); ?>" class="font-semibold text-brand-700">Masuk di sini</a>
    </p>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\renggo\resources\views/auth/login-customer.blade.php ENDPATH**/ ?>